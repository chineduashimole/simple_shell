 ...
 *	this is used to constant function prototype.
 * Return: 0
 */
...
/**
 * _unsetenv - this function remove an environment variable
 * @info: the structure containing potential arguments.
 *	this is used to maintain constant function prototype
 * @var: the property of the string env var
 * Return: On delete return 1, otherwise 0
 */
